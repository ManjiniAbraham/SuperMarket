...
public WebDriver driver;
	...
	@FindBy(xpath="//a[contains(@class,'nav-link') and @data-toggle='dropdown']")WebElement menuBarField;
	@FindBy(xpath="//i[contains(@class,'fa-power-off' )]")WebElement logoutButton;
